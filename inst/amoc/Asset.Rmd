...
dataframe = data.frame(y=data, time=time_normalized,trend=trend1,trend2=trend2, idx=1:n,idy=1:n,time=time)
  ...
  res1 = inla.ews(data = dataframe,model = "ar2", formula = formula1) # Inla fit using Linear Trend
  
  res2 = inla.ews(data = dataframe,model = "ar2", formula = formula2) # Inla fit using Square Trend
  
  resrw2 = inla.ews(data = dataframe,model = "ar2", formula = formularw2) # Inla fit using RW2 Trend
