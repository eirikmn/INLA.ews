...
The plot below shows the estimated posterior marginal mean for the lag-one correlation coefficient in the above example, with 95% credible intervals included. The black line represents the 'true' development of the memory.
